...
public class UrlReplacerTest
{
    ...
    public void urlEncodeReplace()
    {
        ...
        String result = urlReplacer.replace(txt);
        Assert.assertEquals("file%3A%2F%2Flo file%3A%2F%2Flocalhost.dinamico.com.br%2Fxy  file%3A%2F%2Flocalhost.dinamico.com.br%2Fxyz", result);
    }
    ...
    public void urlEncodeReplaceEndText()
    {
        ...
        String result = urlReplacer.replace(txt);
        Assert.assertEquals("?file%3A%2F%2Flo file%3A%2F%2Flocalhost.dinamico.com.br%2Fxy  file%3A%2F%2Flocalhost.dinamico.com.br?", result);
    }
